...
public class BSTRecursiveGeneric<T extends Comparable<T>> {
  ...
  public static void main(String[] args) {
    ...
    // Integer
    com.dailycodebuffer.Trees.BSTRecursiveGeneric<Integer> integerTree = new com.dailycodebuffer.Trees.BSTRecursiveGeneric<Integer>();
    ...
    */
    ...
    // String
    com.dailycodebuffer.Trees.BSTRecursiveGeneric<String> stringTree = new com.dailycodebuffer.Trees.BSTRecursiveGeneric<String>();
